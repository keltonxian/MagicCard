...
local function create(images, sounds, musics, nextSceneCreateFunc, adType)
    ...
    if __G__isOrientationLandscape then
        bgImg = __G__iOSValue("loadings/BGI/landscape/640x960.png", "loadings/BGI/landscape/640x1136.png","loadings/BGI/landscape/768x1024.png")
        progressBgImg1 = "loadings/BGI/landscape/1.png"
        progressBgImg2 = "loadings/BGI/landscape/2.png"
        progressBg_x=__G__iOSValue(232,320,264)
        progressBg_y=__G__iOSValue(60,61,108)
    else
        bgImg = __G__iOSValue("loadings/BGI/portrait/640x960.png", "loadings/BGI/portrait/640x1136.png","loadings/BGI/portrait/768x1024.png")
        progressBgImg1 = "loadings/BGI/portrait/1.png"
        progressBgImg2 = "loadings/BGI/portrait/2.png"
